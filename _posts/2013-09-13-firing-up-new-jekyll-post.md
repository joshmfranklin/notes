...
<ol>
	...
	<li>
		<p>After you have commited your git content you will push it to gh-pages. To do this simply use <code>git push github gh-pages</code>, your changes should then be added yo your active blog and be ready for viewing!</p>
	</li>
</ol>
